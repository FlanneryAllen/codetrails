      ...
      >
        ...
        <div style={{ marginBottom: "60px" }}>
          ...
          <div style={{ marginBottom: "32px" }}>
            ...
            >
              System Stories Overview
            </h3>
            <VideoPlayer
              videoId="system-stories"
              videoTitle="System Stories Demo"
              src="/SystemStories.mov"
              width="100%"
            />
          </div>
          ...
          <div style={{ marginBottom: "32px" }}>
            ...
            <VideoPlayer
              videoId="agents-and-more"
              videoTitle="Agents and More Demo"
              src="/agents_and_more.mov"
              width="100%"
            />
          </div>
        </div>
